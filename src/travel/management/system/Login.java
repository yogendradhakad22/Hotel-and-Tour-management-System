...
public class Login extends JFrame implements ActionListener {
	...
	private JPanel panel; // for dividing in multiple panels
	...
	public Login() {
		...
		panel = new JPanel();
		panel.setBackground(Color.WHITE); // coloring the panel
		setContentPane(panel);
		panel.setLayout(null);//customized layout

		JLabel l1 = new JLabel("Username : ");
		l1.setBounds(124, 89, 95, 24); // x and y if location
		panel.add(l1);
		...
		textField = new JTextField(); // for empty textfield
		...
		b1.setForeground(new Color(46, 139, 87)); // text color of word
